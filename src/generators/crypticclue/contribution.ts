...
export const crypticClueContribution: PackContribution = {
  ...
  //
  // IT SUPPRESSES THE ALARM, NEVER THE ATTEMPT. missingDifficulties still asks for this type on the
  // scheduled paths. What it also means, and is worth stating rather than discovering: with
  // bestEffort on, a pack missing ONLY its cryptic clue reads complete, so a GET can never repair
  // one. Repair is the 03:33 and 05:33 runs only.
  bestEffort: true,
  countPerDay: 1,
