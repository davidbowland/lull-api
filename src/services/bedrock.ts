...
// generatePhrases and reviewPhrases, both of which run inside CreatePhrasePuzzlesFunction under a
// 900s timeout, so the added inter-attempt backoff sleep is not a meaningful timeout risk.
//
